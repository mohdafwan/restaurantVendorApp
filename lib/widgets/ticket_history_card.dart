...
import 'package:restaurant_vendor_app/models/tickets/ticket_model.dart';
...
class TicketItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Padding(
        padding:
            const EdgeInsets.all(12.0), // Adjust padding for overall content
        child: Row(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(
                    8.0), // Adjust border radius for pill-like shape
              ),
              child: Text(
                ticket.status,
                style: TextStyle(
