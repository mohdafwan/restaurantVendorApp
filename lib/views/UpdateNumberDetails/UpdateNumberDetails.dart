...
import 'package:restaurant_vendor_app/views/VerifyPhoneNoUsingOTP/VerifyPhoneNoUsingOTP.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() => SizedBox(
                    ...
                    child: Button(
                      onPressed: () async {
                        final res = await Get.find<AuthMethods>()
                            .getUserWithPhoneNumber(
                                e164phoneNumber:
                                    controller.getE164FormattedPhoneNumber());
                        if (res.message == "success") {
                          if (context.mounted) {
                            showToastMessage(context,
                                "The phone number you entered is already in\nuse. Please provide a different phone number.");
                          }
                          return;
                        }
