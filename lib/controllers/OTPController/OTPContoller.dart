...
import 'package:restaurant_vendor_app/models/OTPModel/OTP.model.dart';
  ...
  Future<void> sendOTPtoPhone(BuildContext context) async {
    userController.updateUserDetails(
        phone: PhoneNumberModel(
            countryCode: phoneController.selectedCountryCode,
            phoneNumber: phoneController.phoneNumber));
    _authMethods.sentOTPtoPhone(
        phoneController.getE164FormattedPhoneNumber(), null, context);
  }
